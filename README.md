...
DockCatWin 的原创概念、行为设计以及默认栗子资源均来自 DockCat 项目。当前移植已同步 DockCat `v0.6` 的主要中文体验与资源内容。
...
当前暂未包含 DockCat `v0.6` 的英文界面切换；DockCatWin 的界面和文档仍以中文为主。
...
- 设置中可修改小猫名字、对你的称呼、显示器、显示缩放、提醒间隔、提醒文案、状态时长和默认出门时间。
